    ...
    services.syncthing = {
      ...
      declarative = {
        devices = {
          ...
          aka.id =
            "IZQ2GAC-I3QBTRT-TXBIG7Z-NT6S66Y-H64WOCO-T3AMKYZ-VGWTNCY-CTQOLQN";
          ao.id =
            "NBMLUKD-PJRXCTM-GQ2WFLE-NN4IGSN-6WSC6JL-M6XN7PE-HCBTOKV-7VER2QE";
          # Windows machine; set up the other end yourself!
          midori.id =
            "BOFH5JP-A3MPTJA-EGIZVWV-URHUTSJ-2ZXCAA2-XMZPPSR-GLMOQFL-ZX7DGQP";
        };
        folders = let
